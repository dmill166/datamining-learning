...
if __name__ == "__main__":
    ...
    random.seed(0)
    df = pd.read_csv(os.path.join(DATA_FOLDER, 'heart.csv'))
    ...
    df_train = pd.read_csv(os.path.join(DATA_FOLDER, 'heart_train.csv'))
    ...
    correct = 0
    df_test = pd.read_csv(os.path.join(DATA_FOLDER, 'heart_test.csv'))
